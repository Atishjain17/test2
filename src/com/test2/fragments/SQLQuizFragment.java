...
public class SQLQuizFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater
				.inflate(R.layout.sql_quiz_fragment, container, false);
		lv = (ListView) v.findViewById(R.id.sql_quiz_list);

		submit = (Button) v.findViewById(R.id.sql_quiz_submit);

		questions = getActivity().getResources().getStringArray(
				R.array.sql_quiz_questions);
		options[0] = getActivity().getResources().getStringArray(
				R.array.sql_quiz_option1);
		options[1] = getActivity().getResources().getStringArray(
				R.array.sql_quiz_option2);
		options[2] = getActivity().getResources().getStringArray(
				R.array.sql_quiz_option3);
		options[3] = getActivity().getResources().getStringArray(
				R.array.sql_quiz_option4);

		ans = getActivity().getResources().getIntArray(
				R.array.sql_quiz_answer1);
		...
		submit.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Toast.makeText(getActivity(), "Got "+ counter5 + "  correct out of "+ questions.length+"!", Toast.LENGTH_LONG).show();
	...
	private class JavaAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			View v = inflater.inflate(R.layout.sql_quiz_listitem, parent,
					false);
			TextView question = (TextView) v.findViewById(R.id.sql_quiz_ques);
